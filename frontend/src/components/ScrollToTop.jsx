        ...
        <>
            {showButton && (
                <button
                    ...
                    className="fixed bottom-6 right-6 z-50 rounded-full bg-blue-600 text-white shadow-lg p-3 md:p-3.5 hover:bg-blue-700 transition flex items-center justify-center"
                >
                    <ArrowUp size={22} />
                </button>
            )}
